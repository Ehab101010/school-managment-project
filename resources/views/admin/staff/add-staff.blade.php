...
<head>
    ...
    <title>إضافة موظف شؤون طلاب</title>
...
<div class="mobile-topbar">
    ...
    <span class="mobile-topbar-title">إضافة موظف</span>
...
<div class="content">
    ...
    <div class="page-hero hero-teal fade-in">
        <div class="page-hero-inner">
            <div>
                <h1><i class='bx bx-user-plus'></i> إضافة موظف شؤون طلاب</h1>
                <p>أدخل بيانات الموظف وسيتم إنشاء حسابه تلقائياً</p>
            </div>
    ...
    <div class="creds-card fade-in">
        <h3><i class='bx bx-check-circle'></i> تم إنشاء حساب الموظف بنجاح</h3>
            ...
            <div>
                ...
                <div class="section-card">
                    ...
                    <div class="section-body">
                        <div class="sf">
                            ...
                            <div class="sf-input-wrap"><i class='bx bx-user'></i>
                                <input type="text" name="full_name" placeholder="أدخل الاسم الكامل" value="{{ old('full_name') }}">
                            </div>
                        </div>
                        <div class="sf">
                        ...
                        <div class="sf">
                            <label>الجنسية</label>
                            <div class="sf-input-wrap"><i class='bx bx-flag'></i>
                                <input type="text" name="nationality" placeholder="مثال: سورية" value="{{ old('nationality') }}">
                            </div>
                        </div>
                        <div class="sf">
                            <label>مكان السكن</label>
                            <div class="sf-input-wrap"><i class='bx bx-home'></i>
                                <input type="text" name="address" placeholder="مثال: دمشق" value="{{ old('address') }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-card">
                    ...
                    <div class="section-body">
                        <div class="sf">
                            ...
                            <div class="sf-input-wrap"><i class='bx bx-phone'></i>
                                <input type="tel" name="phone" placeholder="05xxxxxxxx" value="{{ old('phone') }}">
                            </div>
                        </div>
                        <div class="sf">
                            <label>البريد الإلكتروني</label>
                            <div class="sf-input-wrap"><i class='bx bx-envelope'></i>
                ...
                <div class="section-card">
                    ...
                    <div class="section-body cols-1">
                        <div class="sf">
                            <div class="sf-input-wrap">
                                <textarea name="notes" rows="3" placeholder="أي ملاحظات خاصة بالموظف...">{{ old('notes') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="side-panel">
                <div class="submit-card">
                    ...
                    <div class="submit-card-body">
                        <div class="info-box teal"><i class='bx bx-info-circle'></i> سيتم إنشاء حساب دخول تلقائي للموظف عند الإضافة.</div>
                        <button type="submit" class="btn-add teal"><i class='bx bx-plus'></i> إضافة الموظف</button>
                ...
                <div class="section-card">
                    ...
                    <div class="section-body cols-1" style="padding:1rem 1.3rem;gap:.6rem;">
                        @foreach(['الاسم الكامل مطلوب','الجنس مطلوب','رقم هاتف صحيح'] as $tip)
